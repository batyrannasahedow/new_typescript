...
export const todoSlice = createSlice({
  ...
  reducers: {
    ...
    updateTodos: (state: TodoInitialState, action: PayloadAction<number>) =>{
      state.todos = [...state.todos.filter((todo: TodoType) => todo.id === action.payload.id ? todo : action.payload),]
    }
  },
});
export const { createTodo, removeTodoById, updateTodo, updateTodos } = todoSlice.actions;
